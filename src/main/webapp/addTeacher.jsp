            ...
            <div class="content">
                ...
                <form action="${pageContext.request.contextPath}/addTeacherServlet" method="post">
                    <table class="edit_table">
                        ...
                        <tr>
                            <td class="edit_left"><label for="tid">编号</label></td>
                            <td class="edit_right">
                                <input name="tid" id="tid" class="student_id" placeholder="请输入教师编号">
                        ...
                        <tr>
                            <td class="edit_left"><label>年级</label></td>
                            <td class="edit_right">
                                <select name="grade">
                        ...
                        <tr>
                            ...
                            <td class="edit_right">
                                <select id="college" name="college" class="college">
                                    <option value="">---------------请选择---------------</option>
                        ...
                        <tr>
                            <td colspan="2"><input type="submit" id="btn2" class="btn_add" value="确定"></td>
                        </tr>
                    </table>
                </form>
            </div>
