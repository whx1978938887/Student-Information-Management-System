                ...
                <form action="${pageContext.request.contextPath}/addTeacherServlet" method="post">
                    <div class="left left-group tab">
                        <div class="input-group">
                            ...
                            <input type="text" name="tid" class="form-control" placeholder="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="age" class="form-control" placeholder="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group">
