                ...
                <form action="${pageContext.request.contextPath}/updateStudentServlet" method="post">
                    ...
                    <div class="left left-group tab">
                        <div class="input-group">
                            ...
                            <div class="form-control">${student.sid}</div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">姓名</span>
                            <input type="text" name="name" value="${student.name}" class="form-control" placeholder="${student.name}" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">年龄</span>
                            <input type="text" name="age" value="${student.age}" class="form-control" placeholder="${student.age}" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">住址</span>
                            <input type="text" name="address" value="${student.address}" class="form-control" placeholder="${student.address}" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    <div class="left left-group tab">
                        <div class="input-group">
                    ...
                    <div class="btn-group">
                        <a href="${pageContext.request.contextPath}/student-list.jsp" class="btn btn-default">返回</a>
                    </div>
                </form>
            </div>
        </div>
