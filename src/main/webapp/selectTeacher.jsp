...
<body>
    <div class="menu">
        ...
        <div class="right">
            ...
            <div class="content">
                <h3>查询教师信息</h3>
                <form action="${pageContext.request.contextPath}/queryTeacherServlet" method="post">
                    <table>
                        <tr class="name1">
                        ...
                        <tr class="id1">
                            <td><label for="tid" class="l">学号</label></td>
                            <td><input name="tid" id="tid" class="student_id1" placeholder="请输入学号">
                            </td>
                        </tr>
                        <tr class="age1">
                    ...
                    <table width="100%" hight="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <c:forEach items="${teachers}" var="teacher" varStatus="t">
                                <tr>
                                    <td class="menu_td">${t.count}</td>
                                    <td class="menu_td">${teacher.tid}</td>
                                    <td class="menu_td">${teacher.name}</td>
                                    <td class="menu_td">${teacher.age}</td>
                                    <td class="menu_td">${teacher.gender}</td>
                                    <td class="menu_td">${teacher.grade}</td>
                                    <td class="menu_td">${teacher.college}</td>
                                    <td class="menu_td">${teacher.specialty}</td>
                                    <td class="menu_td">${teacher.address}</td>
                                    <td class="menu_td">
                                        <a href="${pageContext.request.contextPath}/findStudentServlet?tid=${teacher.tid}" class="button1">编辑</a>
                                        <a href="${pageContext.request.contextPath}/delTeacherServlet?tid=${teacher.tid}" class="button2">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
