...
<body class="edit_bgc">
    <div class="big">
        <form action="${pageContext.request.contextPath}/updateTeacherServlet" method="post">
            ...
            <table>
                <caption>编辑教师信息</caption>
                <tr>
                    <td class="left"><label for="username">姓名</label></td>
                    <td class="right"><input name="username" id="username" placeholder="请输入姓名"></td>
                </tr>
                <tr>
                    <td class="left">教师编号</td>
                    <td class="right">${teacher.tid}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td id="esc"><a id="esc_a" href="${pageContext.request.contextPath}/findListTeacher">返回</a></td>
                </tr>
            </table>
        </form>
    </div>
