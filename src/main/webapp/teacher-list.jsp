                ...
                <form action="${pageContext.request.contextPath}/queryTeacherServlet" method="post">
                    <div class="left left-group tab">
                        <div class="input-group">
                            ...
                            <input type="text" name="tid" class="form-control" placeholder="不限" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group">
                    ...
                    <div class="btn-group">
                        <a href="${pageContext.request.contextPath}/teacher-add.jsp" class="btn btn-default">添加教师</a>
                    </div>
                </form>
            </div>
            ...
            <table class="table">
                ...
                <c:forEach items="${teachers}" var="teacher" varStatus="t">
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="${pageContext.request.contextPath}/findTeacherServlet?tid=${teacher.tid}" class="btn btn-default">修改</a>
                            </div>
                            <div class="btn-group">
                                <a href="${pageContext.request.contextPath}/delTeacherServlet?tid=${teacher.tid}" class="btn btn-default">删除</a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
